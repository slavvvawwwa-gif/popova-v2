  ...
  return (
    ...
    >
      ...
      <nav style={{ display:"flex", gap:"2rem", alignItems:"center" }} className="hidden md:flex">
        ...
        <button onClick={() => setLocale(locale==="ru"?"en":"ru")} style={{ background:"none", border:"1px solid rgba(240,240,240,0.15)", color:"var(--text-2)", fontSize:"0.55rem", letterSpacing:"0.18em", textTransform:"uppercase", padding:"0.3rem 0.6rem", cursor:"pointer", transition:"border-color 250ms, color 250ms" }}>
          {locale==="ru"?"EN":"RU"}
        </button>
      </nav>
