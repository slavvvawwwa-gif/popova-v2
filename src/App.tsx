...
function AppInner() {
  ...
  return (
    <>
      ...
      <footer style={{ position:"relative", zIndex:1, textAlign:"center", padding:"3rem 0", borderTop:"1px solid rgba(240,240,240,0.05)", color:"var(--text-3)", fontSize:"0.7rem", letterSpacing:"0.1em" }}>
